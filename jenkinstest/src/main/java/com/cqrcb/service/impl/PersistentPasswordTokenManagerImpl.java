...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.cqrcb.service.impl.PasswordTokenManager#generateRecoveryToken(com.cqrcb.model.User)
     */
    @Override
    ...
    /**
     * @see com.cqrcb.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.cqrcb.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.cqrcb.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
